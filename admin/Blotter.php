...
// Sample blotter records data
$blotterRecords = [
    [
        'blotter_id' => 'B1-2024-0001',
        'complainant' => 'Kobe Tayco',
        'respondent' => 'Sam',
        'incident' => 'Theft',
        'date_incident' => '10/24/2024',
        'date_reported' => '10/24/2024',
        'status' => 'Pending'
    ],
    [
        'blotter_id' => 'B1-2024-0002',
        'complainant' => 'Edrian Valdez',
        'respondent' => 'Doe',
        'incident' => 'Tessgassing',
        'date_incident' => '10/22/2024',
        'date_reported' => '10/24/2024',
        'status' => 'Settled'
    ],
    [
        'blotter_id' => 'B1-2024-0003',
        'complainant' => 'Althird Aranilla',
        'respondent' => 'Honey',
        'incident' => 'Snatch',
        'date_incident' => '10/20/2024',
        'date_reported' => '10/24/2024',
        'status' => 'Dismissed'
    ],
    [
        'blotter_id' => 'B1-2024-0004',
        'complainant' => 'Christian Somera',
        'respondent' => 'Chan',
        'incident' => 'Theft',
        'date_incident' => '10/20/2024',
        'date_reported' => '10/24/2024',
    ...
    [
        'blotter_id' => 'B1-2024-0005',
        'complainant' => 'Mark de Guzman',
        'respondent' => 'Dean',
        'incident' => 'Theft',
        'date_incident' => '10/19/2024',
        'date_reported' => '10/24/2024',
        'status' => 'Settled'
    ]
];
        ...
        <div class="admin-main-content">
            <div class="admin-header">
                ...
                <div class="admin-header-right">
                    <div class="admin-search-container">
                        ...
                        <input type="text" class="admin-search-input" placeholder="Search blotter records...">
                    </div>
            ...
            <div class="admin-dashboard-section">
                <div class="admin-section-header">
                    <h2 class="admin-section-title">Blotter/Incident Complaint</h2>
                ...
                <div class="admin-table-container">
                    <table class="admin-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo $record['blotter_id']; ?></td>
                                <td><?php echo $record['complainant']; ?></td>
                                <td><?php echo $record['respondent']; ?></td>
                                <td><?php echo $record['incident']; ?></td>
                                <td><?php echo $record['date_incident']; ?></td>
                                <td><?php echo $record['date_reported']; ?></td>
                                <td>
                                    <span class="admin-status-badge" style="background-color: <?php echo $statusColors[$record['status']]; ?>; color: white;">
                ...
                <div class="admin-table-footer">
                    <div class="admin-entries-info">
                        Showing 1 to <?php echo count($blotterRecords); ?> of <?php echo count($blotterRecords); ?> entries
                    </div>
    ...
    <script>
        ...
        document.querySelectorAll('.admin-btn-view').forEach(btn => {
            btn.addEventListener('click', function() {
                alert('View blotter details');
            });
        });

        document.querySelectorAll('.admin-btn-edit').forEach(btn => {
            btn.addEventListener('click', function() {
                alert('Edit blotter record');
            });
        });

        document.querySelectorAll('.admin-btn-print').forEach(btn => {
            btn.addEventListener('click', function() {
                alert('Print blotter record');
            });
        });

        // Add new blotter button
        document.querySelector('.admin-btn-add').addEventListener('click', function() {
            alert('Add new blotter form');
        });
    </script>
</body>
</html>