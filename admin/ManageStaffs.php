...
<body>
            ...
            <div class="admin-dashboard-section">
                ...
                <div class="admin-table-footer">
                    <div class="admin-entries-info">
                        Showing 1 to 5 of <?php echo count($staffMembers); ?> entries
                    </div>
    ...
    <script>
        ...
        mobileMenuButton.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z"/></svg>';
        document.body.prepend(mobileMenuButton);
