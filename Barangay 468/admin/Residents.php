...
$nav_items = [
    [
        'name' => 'Dashboard',
        'icon' => 'dashboard',
        'url' => 'Dashboard.php', // Use absolute path
        'active' => false,
        'expandable' => false,
        'submenu' => []
    ],
    ...
    [
        ...
        'submenu' => [
            [
                ...
                'url' => 'Residents.php', // Ensure this matches the file name
                'icon' => 'circle',
                'active' => true
            ],
            [
            ...
            <?php if (mysqli_num_rows($result) > $entries_per_page): ?>
                <div class="pagination" style="margin-top: 20px; text-align: center;">
                    ...
                    for ($i = 1; $i <= $total_pages; $i++): ?>
                        <a href="?page=<?php echo $i; ?>" style="padding: 5px 10px; margin: 0 5px; text-decoration: none; color: #333; <?php echo $i == $page ? 'font-weight: bold; color: #4CAF50;' : ''; ?>"><?php echo $i; ?></a>
                    <?php endfor; ?>
                </div>
            <?php endif; ?>
        </div>
